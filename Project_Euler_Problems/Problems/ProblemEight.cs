...
namespace Project_Euler_Problems
{
    public class ProblemEight
    {
        ...
        public static void Start()
        {
            ...
            ThirteenDigitsWithGreatestProduct(giantNumber);
        }
